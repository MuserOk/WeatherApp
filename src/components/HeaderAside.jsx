  ...
  if (!data) {
    return (
      <div className='bg-[#1e213a] w-screen md:w-[45%] min-h-screen pt-7 flex flex-col items-center justify-center'>
        ...
        <button className='mt-5 hover:bg-gray-300 active:bg-gray-500 cursor-pointer w-10 md:w-8 h-10 md:h-8 bg-gray-400 rounded-full p-1.5'>
    ...
    <>
      <div className='bg-[#1e213a] w-scren md:w-[45%] min-h-screen pt-7 flex flex-col items-center'>
        <header className='pb-1 mt-10 flex justify-between items-center w-full md:justify-around px-5 md:px-0'>
          <div className='hover:bg-gray-300 active:bg-gray-300 bg-gray-400 py-1.5 w-40 md:w-32 flex justify-center' action="">
            <input className=' cursor-pointer h-full w-38 md:w-30 text-center placeholder-white' type="text" placeholder='Search fo Places' />
          </div>
          <button className='mt-5 hover:bg-gray-300 active:bg-gray-500 cursor-pointer w-10 md:w-8 h-10 md:h-8 bg-gray-400 rounded-full p-1.5'>
            <img src="/location.svg" alt="Get location" />
        ...
        <div className='flex flex-col items-center md:pt-10 md:w-full md:overflow-hidden'>
          <div className="relative min-w-screen h-50 md:w-[30%]">
            ...
            <div className="relative z-10 flex justify-center items-center h-full">
              <img className="w-36 md:w-36" src={`/weather/${data.weather[0].icon}.png`} alt="Weather icon" />
            </div>
          </div>
          ...
          <h2 className=" capitalize pt-6 pb-12 md:text-2xl text-3xl text-[#A09FB1] font-semibold">{data.weather[0].description}</h2>
          <p className="text-sm md:text-xs text-[#88869D] font-medium mb-6">Today &nbsp;&nbsp; . &nbsp;&nbsp; {today}</p>
        </div>
